const width = $(document).width(),
    ...
    dx = 20,		// How sparse vertically
    dy = width / 6; // How sparse horizontally
...
d3.json("data/flare.json").then(function(data) {
    ...
    root.descendants().forEach((d, i) => {
        ...
        // Initialize layout
        if (d.depth && d.data.name.length >= 5) d.children = null;
    });
...
// 3. eachBefore: pre-order traversal, root then children
